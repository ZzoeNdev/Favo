function BlocoFuncionalidade({titulo, logo, texto}) {

  return (
    <div className="bg-gradient-to-r from-[#EEEEEE]/50 to-[#F9F9F9]/50 rounded-[10px] border border-[#DFDFDF] min-w-[16rem] p-3 md:max-w-25 md:gap-5 md:p-3">
